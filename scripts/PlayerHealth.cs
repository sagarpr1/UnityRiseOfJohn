...
{	
	...
	void OnCollisionEnter2D (Collision2D col)
	{
		...
		if((col.gameObject.tag == "Enemy") || (col.gameObject.tag == "EnemyRocket"))
		{
	...
	void TakeDamage (Transform enemy)
	{
		...
		//ps playerControl.jump = false;

		// Create a vector that's from the enemy to the player with an upwards boost.
		Vector3 hurtVector = transform.position - enemy.position + Vector3.up * 1f;
